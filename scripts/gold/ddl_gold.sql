/* ============================================================
   ...
   Script Purpose:
     This script creates the semantic (Gold) layer views used for
     analytics and reporting. Existing views are dropped and
     recreated to ensure structure consistency.
